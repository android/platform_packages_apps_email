...
public class EmnReceiverTests extends TestCase {
    ...
    private static final String EMAIL_FIRST_DOT_COM_ENCODED =
        "030D6A00850703656D61696C4061646472657373008505C30620100804084401";
    private static final String INVALID_EMN_TAG =
        "030D6A00360703656D61696C40616464726573732E636F6D0005C30620100804084401";
    private static final String MISSING_INLINE_STRING_TAG =
        "030D6A00850785656D61696C40616464726573732E636F6D0005C30620100804084401";
    private static final String TRUNCATED_AFTER_INLINE_STRING =
        "030D6A00850703";
    private static final String MISSING_NULL =
    ...
    private static byte[] fromHexString(final String encoded) {
        ...
        for (int i = 0; i < encoded.length(); i += 2) {
            hexPair = encoded.substring(i, i + 2);
