...
public class AttachmentService extends Service implements Runnable {
    ...
    public static void start(Context context, Intent intent) {
        if (context.getApplicationInfo().targetSdkVersion >= android.os.Build.VERSION_CODES.O && !isRunning) {
        ...
        if (getApplicationInfo().targetSdkVersion >= android.os.Build.VERSION_CODES.O) {
            ...
            startForeground(
                    ...
                    EmailNotificationController.getOngoingDownloadNotification(
                            ...
                            getApplicationContext().getString(R.string.notification_downloading_attachments_title)));
        }
